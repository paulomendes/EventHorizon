...
// EventHorizon
#define COCOAPODS_POD_AVAILABLE_EventHorizon
#define COCOAPODS_VERSION_MAJOR_EventHorizon 0
#define COCOAPODS_VERSION_MINOR_EventHorizon 1
#define COCOAPODS_VERSION_PATCH_EventHorizon 0
